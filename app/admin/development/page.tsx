...
import { Plus, Edit2, Trash2, Terminal, ExternalLink, CheckCircle2, Loader2, X } from 'lucide-react'
...
export default function AdminDevelopmentPage() {
  ...
  const [category, setCategory] = useState('Workstation Hardware')
  ...
  const openModal = (item?: DevelopmentSetup) => {
    if (item) {
      ...
      setTitle('')
      setSubtitle('')
      setCategory('Workstation Hardware')
      setWhyIUseIt('')
      setTagsInput('')
      setConfigFilename('')
      setConfigCode('')
  ...
  const columns: Column<DevelopmentSetup>[] = [
    ...
    },
    {
      ...
      header: 'Why I Use It',
      render: (item) => (
        <p className="text-xs font-sans text-zinc-400 max-w-xs truncate">{item.whyIUseIt}</p>
      ),
    },
    {
      key: 'actions',
          ...
          <div className="relative z-10 w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-2xl space-y-4 font-sans max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
              <h2 className="text-base font-bold font-mono text-white">
                {editingId ? 'Edit Setup Entry' : 'Add Setup Entry'}
              </h2>
            ...
            <form onSubmit={handleSave} className="space-y-3 font-mono text-xs">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    placeholder="Workstation Hardware"
                    className="w-full p-2.5 bg-zinc-950 border border-zinc-800 rounded-xl text-white focus:outline-none focus:border-zinc-500"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder="Physical workstation hardware & peripherals"
                  className="w-full p-2.5 bg-zinc-950 border border-zinc-800 rounded-xl text-white focus:outline-none focus:border-zinc-500"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  placeholder="Designed for high-throughput development, silent operation, and ergonomic typing..."
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder="MacBook Pro, Keychron K2, MX Master 3S"
                  className="w-full p-2.5 bg-zinc-950 border border-zinc-800 rounded-xl text-white focus:outline-none focus:border-zinc-500"
                />
              </div>
