  ...
  return (
    ...
    >
      <div className="relative group p-5 sm:p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800/80 bg-zinc-50/50 dark:bg-zinc-900/30 hover:border-zinc-300 dark:hover:border-zinc-700/90 transition-all duration-500 shadow-2xs">
        ...
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-emerald-500/0 via-emerald-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />

        <div className="relative flex items-start gap-4">
          <div className="p-2 rounded-xl bg-zinc-100 dark:bg-zinc-800/60 text-zinc-400 dark:text-zinc-500 shrink-0 mt-0.5 group-hover:text-emerald-500 dark:group-hover:text-emerald-400 transition-colors">
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      title="Shuffle daily quotes"
                      className="p-1 rounded-lg text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-200 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/60 transition-all opacity-0 group-hover:opacity-100 cursor-pointer"
                    >
                      <RefreshCw
