...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 bottom-0 z-50 w-64 bg-zinc-950 border-r border-zinc-800/80 text-zinc-300 flex flex-col transition-transform duration-200 ease-in-out lg:translate-x-0 ${
