        ...
        {CONTRIBUTIONS.map((item, index) => {
          ...
          return (
            <motion.a
              ...
              className={`group relative flex flex-col lg:flex-row lg:items-center justify-between gap-6 py-12 md:py-16 border-b border-neutral-200 dark:border-white/[0.1] transition-opacity duration-200 cursor-pointer ${
            ...
            >
              ...
              <div className="flex flex-col md:flex-row lg:items-center justify-between w-full lg:w-1/2 pl-12 md:pl-20 lg:pl-0 gap-6 lg:gap-12 relative z-10">
                <div className="flex flex-wrap gap-3">
                  <span className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono border border-neutral-200 dark:border-neutral-800 rounded-full text-neutral-600 dark:text-neutral-300 group-hover:border-neutral-400 dark:group-hover:border-neutral-700 bg-white dark:bg-zinc-900 transition-colors duration-200">
                    {item.repo}
                  </span>
                  <span className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono border border-neutral-200 dark:border-neutral-800 rounded-full text-neutral-600 dark:text-neutral-300 group-hover:border-neutral-400 dark:group-hover:border-neutral-700 bg-white dark:bg-zinc-900 transition-colors duration-200">
                ...
                <div className="flex items-center gap-6">
                  <div className="p-3 rounded-full bg-neutral-100 dark:bg-zinc-900 text-neutral-900 dark:text-white group-hover:bg-neutral-900 group-hover:dark:bg-white group-hover:text-white group-hover:dark:text-neutral-900 group-hover:scale-110 transition-all duration-200 flex items-center justify-center">
